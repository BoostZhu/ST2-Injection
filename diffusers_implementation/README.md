...
cd /root/autodl-tmp/VISION && python vision_dev/diffusers_implementation/run_styleid_diffusers.py --cnt_fn data/firstframe/bird_forest/anchorframe.jpg --sty_fn data/styles/tsn/the_starry_night.png